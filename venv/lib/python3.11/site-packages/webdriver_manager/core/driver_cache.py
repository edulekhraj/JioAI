...
class DriverCacheManager(object):
    ...
    def save_file_to_cache(self, self: Driver, file: File):
    ...
    def __save_metadata(self, self: Driver, binary_path, date=None):
        if date is None:
    ...
    def find_driver(self, self: Driver):
        """Find self by '{os_type}_{driver_name}_{driver_version}_{browser_version}'."""
    ...
    def __get_metadata_key(self, self: Driver):
