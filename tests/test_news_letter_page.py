...
class TestNEWSLETTERS:
    ...
    @pytest.mark.newsletters
    def test_verify_news_letter_page_title(self, driver, base):
        base.login_page.login_with_valid_password(self.user, self.pwd)
        title = base.news_letter.news_letter_page_title()
        assert title == "Newsletter"

    @pytest.mark.newsletters
    def test_verify_title_for_news_letter1(self, driver, base):
        base.login_page.login_with_valid_password(self.user, self.pwd)
    ...
    @pytest.mark.newsletters
    def test_verify_title_for_news_letter2(self, driver, base):
        base.login_page.login_with_valid_password(self.user, self.pwd)
    ...
    @pytest.mark.newsletters
    def test_verify_title_for_news_letter3(self, driver, base):
        base.login_page.login_with_valid_password(self.user, self.pwd)
    ...
    @pytest.mark.newsletters
    def test_verify_title_for_news_letter4(self, driver, base):
        base.login_page.login_with_valid_password(self.user, self.pwd)
    ...
    @pytest.mark.newsletters
    def test_verify_title_for_news_letter5(self, driver, base):
        base.login_page.login_with_valid_password(self.user, self.pwd)
    ...
    @pytest.mark.newsletters
    def test_open_all_news_letters(self, driver, base):
        base.login_page.login_with_valid_password(self.user, self.pwd)
        base.news_letter.open_news_letter()
